    ...
    const menuCategories = [
        {
            ...
            dishes: [
                ...
                { name: 'Суши сет (2 вида)', price: 15, checked: false, half: false },
                { name: 'Соленое ассорти (банкет)', price: 8, checked: false, half: false },
                { name: 'Суши сет (3 вида)', price: 25, checked: false, half: false },
                ...
                { name: 'Мучной сет', price: 21, checked: false, half: false },
                { name: 'Рыбное ассорти VIP', price: 80, checked: false, half: false },
                ...
                { name: 'Фруктовая нарезка', price: 20, checked: false, half: false },
                { name: 'Брускетты микс', price: 12, checked: false, half: true },
                { name: 'Фруктовая нарезка VIP', price: 24, checked: false, half: false },
                { name: 'Рулетики с лаваша', price: 10, checked: false, half: true },
                { name: 'Мороженное', price: 10, checked: false, half: false },
                { name: 'Куриные ножки с фри', price: 26, checked: false, half: true },
                { name: 'Хлеб (садака)', price: 4, checked: false, half: false },
                { name: 'Нагетсы микс с фри', price: 28, checked: false, half: true },
                { name: 'Хлеб (банкет)', price: 8, checked: false, half: false },
                { name: 'Чикен микс VIP', price: 32, checked: false, half: true },
